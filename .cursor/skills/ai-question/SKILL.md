...
项目根目录：`ai-question-skill`（FastAPI 应用 + 本 skill）。
...
```bash
python .cursor/skills/ai-question/scripts/extract_material.py "资料.docx" -o data/material-extract.txt
```
...
```bash
python .cursor/skills/ai-question/scripts/export_question_bank.py data/generated-bank.json -o "输出题库.xlsx"
```
...
```bash
python .cursor/skills/ai-question/scripts/import_bank_to_db.py data/generated-bank.json
```
...
```bash
python .cursor/skills/ai-question/scripts/generate_question_bank.py "资料.pdf" -o "输出.xlsx" --json data/generated-bank.json
```
...
```bash
python .cursor/skills/ai-question/scripts/normalize_question_bank.py "原始题库.docx" -o "规范题库.xlsx"
```
...
或 `.\.cursor\skills\ai-question\scripts\start_question_service.ps1`
...
```powershell
.\.cursor\skills\ai-question\scripts\stop_question_service.ps1
```
